...
const deleteManifestVersionInLocalStorage = (): void => {
  const { localStorage } = window;
...
const getDefinitionManifestFromIndexDB = async (manifestName: string, hashes: number[]): Promise<Manifest<unknown>> => {
...
const getCompleteDefinitionManifestFromIndexDB = async (manifestName: string): Promise<Manifest<unknown>> => {
...
export const getClassManifest = async (hashes: number[]): Promise<Manifest<DestinyClassDefinition>> => {
  return getDefinitionManifestFromIndexDB(DefinitionManifestsEnum.DestinyClassDefinition, hashes) as Promise<
    Manifest<DestinyClassDefinition>
  >;
};

export const getGenderManifest = async (hashes: number[]): Promise<Manifest<DestinyGenderDefinition>> => {
  return getDefinitionManifestFromIndexDB(DefinitionManifestsEnum.DestinyGenderDefinition, hashes) as Promise<
    Manifest<DestinyGenderDefinition>
  >;
};

export const getRaceManifest = async (hashes: number[]): Promise<Manifest<DestinyRaceDefinition>> => {
  return getDefinitionManifestFromIndexDB(DefinitionManifestsEnum.DestinyRaceDefinition, hashes) as Promise<
...
export const getCompleteInventoryItemManifest = async (): Promise<Manifest<DestinyInventoryItemDefinition>> => {
  return getCompleteDefinitionManifestFromIndexDB(DefinitionManifestsEnum.DestinyInventoryItemDefinition) as Promise<
    Manifest<DestinyInventoryItemDefinition>
  >;
};

export const getCompleteStatManifest = async (): Promise<Manifest<DestinyStatDefinition>> => {
  return getCompleteDefinitionManifestFromIndexDB(DefinitionManifestsEnum.DestinyStatDefinition) as Promise<
    Manifest<DestinyStatDefinition>
  >;
};

export const getCompleteDamageTypeManifest = async (): Promise<Manifest<DestinyDamageTypeDefinition>> => {
  return getCompleteDefinitionManifestFromIndexDB(DefinitionManifestsEnum.DestinyDamageTypeDefinition) as Promise<
...
export const getCompletePlugSetManifest = async (): Promise<Manifest<DestinyPlugSetDefinition>> => {
  return getCompleteDefinitionManifestFromIndexDB(DefinitionManifestsEnum.DestinyPlugSetDefinition) as Promise<
    Manifest<DestinyPlugSetDefinition>
  >;
};

export const getCompleteEnergyTypeManifest = async (): Promise<Manifest<DestinyEnergyTypeDefinition>> => {
  return getCompleteDefinitionManifestFromIndexDB(DefinitionManifestsEnum.DestinyEnergyTypeDefinition) as Promise<
...
export const freshSaveOfAllDefinitionManifests = async (
  ...
  try {
    for (const manifestWrapper of manifestResponseWrappers) {
      ...
      console.log(`Saved ${manifestWrapper.name} to idb`);
    }
  } catch (error) {
    console.error(`Failed to save manifest to DB: ${error}`);
    deleteManifestVersionInLocalStorage();
  }

  console.log('Finished processing manifests');
};
