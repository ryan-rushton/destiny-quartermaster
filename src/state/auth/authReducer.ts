...
const saveAuthTokenReducer: CaseReducer<AuthState, SaveAuthAction> = (state, action) => action.payload;
 ...
 */
export const isTokenValid = (tokenTime: number, savedTokenTime: number, startOfAuth: number): boolean => {
